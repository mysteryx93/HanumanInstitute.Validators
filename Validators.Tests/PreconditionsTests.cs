...
public class PreconditionsTests
{
    ...
    [Theory]
    [InlineData(1d, null, false, null, false)]
    [InlineData(1.0, 0d, true, null, false)]
    [InlineData(0d, 0d, true, null, false)]
    [InlineData(1.1, 1d, false, null, false)]
    ...
    [InlineData(0d, null, true, 0d, true)]
    ...
    [InlineData(0.1, 0d, false, 1d, false)]
    [InlineData(-10d, -10d, true, -1d, true)]
    [InlineData(-1d, -10d, true, -1d, true)]
